      ...
      <tr>
        ...
        <td class="container" style="font-family: sans-serif;font-size: 16px !important;vertical-align: top;display: block;max-width: 580px;padding: 0 !important;width: 100% !important;margin: 0 auto !important;">
          <div class="content" style="box-sizing: border-box;display: block;margin: 0 auto;max-width: 580px;padding: 0 !important;">
            ...
            <span class="preheader" style="color: transparent;display: none;height: 0;max-height: 0;max-width: 0;opacity: 0;overflow: hidden;mso-hide: all;visibility: hidden;width: 0;font-size: 16px !important;">Contractor Compilance - Dear {{ Auth::guard('user')->user()->name }} On {{ date('Y-m-d H:i:s') }} Thank you for submitting your CCA application</span>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;">
                    ...
                    <tr>
                      <td style="font-family: sans-serif;font-size: 16px !important;vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif;font-size: 16px !important;font-weight: normal;margin: 0;margin-bottom: 15px;"> Dear  {{Auth::guard('user')->user()->name }} </p>
                        <p style="font-family: sans-serif;font-size: 16px !important;font-weight: normal;margin: 0;margin-bottom: 15px;">Thank you for submitting your CCA application, the CCA team will review your application and will be in contact with you within 48 hours if we require any further information.</p>
                        ...
                        <p style="font-family: sans-serif;font-size: 16px !important;font-weight: normal;margin: 0;margin-bottom: 15px;">If you have any questions please call our office on 1300 795 055.</p>
            ...
            <div class="footer" style="clear: both;padding-top: 10px;text-align: center;width: 100%;">
              <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate;mso-table-lspace: 0pt;mso-table-rspace: 0pt;width: 100%;">
                <tr>
                  <td class="content-block" style="font-family: sans-serif;font-size: 16px !important;vertical-align: top;color: #999999;text-align: center;">
                    <span class="apple-link" style="color: #999999;font-size: 16px !important;text-align: center;"><a href="http://www.contractorcompliance.com.au/" style="color: #999999;text-decoration: underline;font-size: 16px !important;text-align: center;"> © Contractor Compliance Australia Pty Ltd </a> </span>
