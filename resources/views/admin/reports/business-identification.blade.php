...
<section>
    ...
    <div id="clients">  
      ...
      <div class="form-group clearfix" >
          ...
          <label class="col-lg-2 control-label " > Client Company 1 </label>
          <div class="col-lg-10">
              <input type="hidden" name="num_1" value="1">
              <input id="client_1"  name="client_1" type="text" class="form-control required">
              <div id="clientList_1">
      ...
      <div class="form-group clearfix" >
          ...
          <label class="col-lg-2 control-label " > Client Company {{++$key}} </label>
          <div class="col-lg-10">
            ...
            <div class="row">
               <div class='col-md-12'>
                   @if(strpos($_SERVER['REQUEST_URI'], 'pdf') !== false )
                    <input type="text" @if($businessIdentification["assessmentDate"]) value="{{ date('d/m/Y', strtotime($businessIdentification["assessmentDate"])) }}" @endif>
                   @else
    ...
    <div class="form-group clearfix">
        ...
        <div class="col-lg-10">
            <div class="row">
               <div class='col-md-12'>
                   @if(strpos($_SERVER['REQUEST_URI'], 'pdf') !== false )
                    <input type="text" @if($businessIdentification["expiryDate"]) value="{{ date('d/m/Y', strtotime($businessIdentification["expiryDate"])) }}" @endif>
                   @else
                   <div class="form-group">
