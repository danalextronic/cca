...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12  "> 
			<div class="card-box">
				@include('pdf.header')
				<h4 class="m-t-0 header-title"><b>Northern Territory Business Compliance Assessment Questionnaire <small>
...
compliance assessment can be conducted accurately and efficiently.
 <strong> Please supply copies of all relevant documentation. </strong></small></b></h4> <br/><br/> 
				...
				<form id="wizard-vertical" enctype="multipart/form-data" method="POST">
					...
					<section>
						...
						<p> 
							...
							5.5% and $1,500,000 (Annually) respectively.
						</p>						
					</section>
