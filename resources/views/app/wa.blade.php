...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12  "> 
			<div class="card-box">
				@include('pdf.header')
				<h4 class="m-t-0 header-title"><b>Western Australia Business Compliance Assessment Questionnaire</b></h4> <small>
					...
					<section>
						...
						<div class="form-group clearfix">		
							@if(strpos($_SERVER['REQUEST_URI'] , 'new') == false)
								...
								<a  href= "{{ route('getFile',['filename' =>  'AppPayrollTax', 'idContractor' => $arrays['application'][0]['contractors_idcontractors'] ,'idApplication' => $arrays['application'][0]['idapplication'] , 'date' => date('y-m-d',strtotime($arrays['application'][0]['updated_at'])) ] ) }}" > 
											 View
								 </a>
								@endif
							@endif
						...
						<p> 
							...
							From 1 July 2012, the rate of tax and the annual threshold before it becomes payable is
							5.5%. $750,000(annually) $62,500.00 (monthly)
						</p>						
					</section>
