...
<div class="container">
	...
	<div class="row">
		<div class="col-sm-12  "> 
			@include('pdf.header')
			<div class="card-box">
				<h4 class="m-t-0 header-title"><b>New South Wales Business Compliance Assessment Questionnaire</b> <br/><small>
...
compliance assessment can be conducted accurately and efficiently.
 <strong> Please supply copies of all relevant documentation. </strong></small></h4> <br/><br/> 
				...
				<form id="wizard-vertical" enctype="multipart/form-data" method="POST">
					...
					<section>
						...
						<p> 
							...
							From 1 July 2013, the rate of tax and the annual threshold before it becomes payable is
							5.45% and $750,000 (annually) respectively.
						</p>						
					</section>
